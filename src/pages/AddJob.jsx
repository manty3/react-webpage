...
onChange={(e)=>setType(e.target.value)}              >
            ...
            <div class="mb-4">
              ...
              <textarea
                ...
                class="border rounded w-full py-2 px-3"
                rows="4"
                placeholder="Add any job duties, expectations, requirements, etc" value={description}
            ...
            <div class="mb-4">
              ...
              <textarea
                ...
                class="border rounded w-full py-2 px-3"
                rows="4"
                placeholder="What does your company do?" value={companyDescription}
            ...
            <div class="mb-4">
              ...
              <input
                ...
                name="contact_phone"
                class="border rounded w-full py-2 px-3"
                placeholder="Optional phone for applicants" value={contactPhone}
